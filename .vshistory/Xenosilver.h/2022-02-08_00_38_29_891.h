...
#pragma endregion
	...
	private: System::Void listBox1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		std::string dathash = hash;
		int fileSize = 0;
		unsigned char* data = nullptr;
		std::string headerhash = getReferenceFromHash(hash, pkgsPath);

		pkgID = getPkgID(headerhash);
